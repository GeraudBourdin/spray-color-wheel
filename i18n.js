...
const UI_STRINGS = {
  ...
  de: {
    ...
    wheelLegendLightness: "Feste Vorschau · L {lightness}",
    wheelGuideCopy:
    ...
    wheelGuideStepLightnessCopy:
      "Der Hintergrund des Rads bleibt fest auf {lightness}. Die echte Helligkeit regelst du mit dem Helligkeit-Regler oder per HEX, nicht mit dem Abstand zur Mitte.",
    paletteEyebrow: "Palette",
    ...
    cartUnitPriceLabel: "Preis pro Spray",
    cartApproximateCostPill: "Ca. Kosten {total}",
    cartApproximateCostHint: "Gib einen Preis pro Spray ein, um die Gesamtkosten zu schaetzen.",
    cartApproximateCostValue: "Ca. Kosten: {sprayLabel} x {unitPrice} = {total}",
    close: "Schliessen",
  ...
  en: {
    ...
    wheelLegendLightness: "Fixed preview · L {lightness}",
    wheelGuideCopy:
    ...
    cartUnitPriceLabel: "Price per spray",
    cartApproximateCostPill: "Approx. cost {total}",
    cartApproximateCostHint: "Enter a price per spray to estimate the total cost.",
    cartApproximateCostValue: "Approx. cost: {sprayLabel} x {unitPrice} = {total}",
    close: "Close",
  ...
  es: {
    ...
    wheelLegendLightness: "Vista fija · L {lightness}",
    wheelGuideCopy:
    ...
    wheelGuideStepLightnessCopy:
      "El fondo de la rueda se mantiene fijo en {lightness}. La luminosidad real se ajusta con el control de Luminosidad o con el HEX, no con la distancia al centro.",
    ...
    cartUnitPriceLabel: "Precio por spray",
    cartApproximateCostPill: "Coste aprox. {total}",
    cartApproximateCostHint: "Indica un precio por spray para estimar el coste total.",
    cartApproximateCostValue: "Coste aprox.: {sprayLabel} x {unitPrice} = {total}",
    close: "Cerrar",
  ...
  pt: {
    ...
    wheelLegendLightness: "Pre-visualizacao fixa · L {lightness}",
    wheelGuideCopy:
    ...
    wheelGuideStepLightnessCopy:
      "O fundo da roda fica fixo em {lightness}. A luminosidade real ajusta-se com o controlo de Luminosidade ou com o HEX, nao com a distancia ao centro.",
    paletteEyebrow: "Paleta",
    ...
    cartUnitPriceLabel: "Preco por spray",
    cartApproximateCostPill: "Custo aprox. {total}",
    cartApproximateCostHint: "Indica um preco por spray para estimar o custo total.",
    cartApproximateCostValue: "Custo aprox.: {sprayLabel} x {unitPrice} = {total}",
    close: "Fechar",
