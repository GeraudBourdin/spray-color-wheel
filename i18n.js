...
const UI_STRINGS = {
  fr: {
    ...
    baseControlsLabel: "Couleur de base",
    hexLabel: "HEX",
    hueLabel: "Teinte",
    ...
    imagePaletteLabel: "Palette image",
    imagePaletteEmpty: "Aucune couleur gardee pour le moment.",
    imageActive: "Base active",
    imagePaletteBrand: "Palette image",
  ...
  de: {
    ...
    imagePaletteLabel: "Bildpalette",
    imagePaletteEmpty: "Noch keine gespeicherte Farbe.",
    imageActive: "Aktive Basis",
    imagePaletteBrand: "Bildpalette",
  ...
  en: {
    ...
    imagePaletteLabel: "Image palette",
    imagePaletteEmpty: "No saved color yet.",
    imageActive: "Active base",
    imagePaletteBrand: "Image palette",
  ...
  es: {
    ...
    imagePaletteLabel: "Paleta de imagen",
    imagePaletteEmpty: "Todavia no hay ningun color guardado.",
    imageActive: "Base activa",
    imagePaletteBrand: "Paleta de imagen",
  ...
  pt: {
    ...
    imagePaletteLabel: "Paleta da imagem",
    imagePaletteEmpty: "Ainda nao existe nenhuma cor guardada.",
    imageActive: "Base ativa",
    imagePaletteBrand: "Paleta da imagem",
